    ...
    <div className="content-body">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title={modalContentId ? modalTitles[modalContentId] : 'Details'}>
        ...
        {modalContentId === 'uniqueDonorsCurrentMonth' && (
          <div className="top-list-content"><ul className="top-list">{data.uniqueDonorsCurrentMonthList.map((donor: DonorData, i: number) => (<li key={donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(donor.donorid)}>{donorInitials(donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(donor.donorid)}>{donorFullName(donor)}</span></div></li>))}</ul></div>
        )}
        ...
        {modalContentId === 'totalValueCurrentMonth' && (<div className="top-list-content"><ul className="top-list">{data.giftsCurrentMonthList.map((item: GiftWithDonor, i: number) => (<li key={item.giftid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor?.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor?.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Gift on {formatDate(item.giftdate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalamount)}</div></li>))}</ul></div>)}
        ...
        {modalContentId === 'medianDonation' && (<div className="top-list-content">{data.medianIndex !== null && (<p style={{ margin: '0 0 1rem' }}><strong>Median Position:</strong> Gift #{data.medianIndex + 1}</p>)}<p style={{ margin: '0 0 1rem' }}><strong>Computed Median:</strong> {formatAmount(metrics.medianDonation)}</p><ul className="top-list">{data.rawDonationsList.map((item: GiftWithDonor, idx: number) => (<li key={item.giftid} className="top-list-item"><div className="top-list-rank">{idx + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor?.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details">Gift ID {item.giftid}<br /><span className="clickable-name" onClick={() => goToDonor(item.donor?.donorid)}>{donorFullName(item.donor)}</span></div><div className="top-list-secondary">{formatAmount(item.totalamount)}<br />{formatDate(item.giftdate)}</div></li>))}</ul></div>)}
        {modalContentId === 'majorDonorsCurrentMonth_Monthly' && (<div className="top-list-content"><ul className="top-list">{data.majorDonorsCurrentMonthList_Monthly.map((item, i) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        {modalContentId === 'mediumDonorsCurrentMonth_Monthly' && (<div className="top-list-content"><ul className="top-list">{data.mediumDonorsCurrentMonthList_Monthly.map((item, i) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        {modalContentId === 'normalDonorsCurrentMonth_Monthly' && (<div className="top-list-content"><ul className="top-list">{data.normalDonorsCurrentMonthList_Monthly.map((item, i) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        {modalContentId === 'majorDonorsCurrentMonth_Onetime' && (<div className="top-list-content"><ul className="top-list">{data.majorDonorsCurrentMonthList_Onetime.map((item, i) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        {modalContentId === 'mediumDonorsCurrentMonth_Onetime' && (<div className="top-list-content"><ul className="top-list">{data.mediumDonorsCurrentMonthList_Onetime.map((item, i) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        ...
        {modalContentId === 'newDonorsThisMonth' && (<div className="top-list-content"><ul className="top-list">{data.newDonorsThisMonthList.map((item: SnapshotDonorInfo, i: number) => (<li key={item.donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(item.donor.donorid)}>{donorInitials(item.donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(item.donor.donorid)}>{donorFullName(item.donor)}</span><span className="top-list-subheader">Last Gift: {formatAmount(item.lastGiftAmount)} on {formatDate(item.lastGiftDate)}</span></div><div className="top-list-secondary">{formatAmount(item.totalAmountThisMonth)}</div></li>))}</ul></div>)}
        ...
        {modalContentId === 'retentionPercentageCurrentMonth' && (
          <div>
            ...
            <div className="top-list-content">
              {activeTab === 'retained' && (<ul className="top-list">{data.retainedDonorsList.map((donor: DonorData, i: number) => (<li key={donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(donor.donorid)}>{donorInitials(donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(donor.donorid)}>{donorFullName(donor)}</span></div></li>))}</ul>)}
              {activeTab === 'churned' && (<ul className="top-list">{data.churnedFromLastMonthList.map((donor: DonorData, i: number) => (<li key={donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(donor.donorid)}>{donorInitials(donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(donor.donorid)}>{donorFullName(donor)}</span></div></li>))}</ul>)}
              {activeTab === 'all' && (<ul className="top-list">{data.lastMonthDonorPool.map((donor: DonorData, i: number) => (<li key={donor.donorid} className="top-list-item"><div className="top-list-rank">{i + 1}</div><div className="top-list-avatar" onClick={() => goToDonor(donor.donorid)}>{donorInitials(donor)}</div><div className="top-list-details"><span className="clickable-name" onClick={() => goToDonor(donor.donorid)}>{donorFullName(donor)}</span></div></li>))}</ul>)}
            </div>
          </div>
        )}
